...
const connect = ({
  ...
  asdf: {
    objects, objectIds, user, setConnectionMessage, setIds, setId, setChatMessages, setMain,
  },
  disconnect: () => { },
  getRelay: () => { },
  setRelay: () => { },
...
//       } else {
//         const errorText =
// `Failed to create game object ${newId}. Error: ${err
// || 'Game object property "score" is not a number'}.
//           `;
